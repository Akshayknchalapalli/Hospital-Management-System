...
function Patient() {
  ...
  const handleAddPatient = (newPatient) => {
    ...
    axios
      .post("http://localhost:9292/addpatient", newPatient)
      .then((response) => {
  ...
  const handleDeletePatient = (PatientId) => {
    ...
    axios
      .delete(`http://localhost:9292/delete/${PatientId}`)
      .then(() => {
  ...
  const handleEditPatient = (editedPatient) => {
    ...
    axios
      .put(`http://localhost:9292/update/${editedPatient.id}`, editedPatient)
      .then(() => {
